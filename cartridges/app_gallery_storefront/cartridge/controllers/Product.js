...
server.get('Show', cache.applyPromotionSensitiveCache, consentTracking.consent, function (req, res, next) {
  ...
  var galleryHelper = require('*/cartridge/controllers/gallery');
  var showProductPageHelperResult = productHelper.showProductPage(req.querystring, req.pageMetaData);
  var showGalleryPageHelperResult = galleryHelper.showGallery(req.querystring);
  ...
  if (!showProductPageHelperResult.product.online && productType !== 'set' && productType !== 'bundle') {
    ...
    res.render(showProductPageHelperResult.template, {
        ...
        gallery: showGalleryPageHelperResult.gallery
      });
  }
  next();
